...
func testCSVWriter(t *testing.T, data [][]string, writeHeader bool, fmtr func(bool) string) {
	...
	schema := arrow.NewSchema(
		[]arrow.Field{
			...
			{Name: "large_str", Type: arrow.BinaryTypes.LargeString, Nullable: true},
			{Name: "ts_s", Type: arrow.FixedWidthTypes.Timestamp_s, Nullable: true},
			{Name: "d32", Type: arrow.FixedWidthTypes.Date32, Nullable: true},
			{Name: "d64", Type: arrow.FixedWidthTypes.Date64, Nullable: true},
			{Name: "dec128", Type: &arrow.Decimal128Type{Precision: 5, Scale: 2}, Nullable: true},
			{Name: "dec256", Type: &arrow.Decimal256Type{Precision: 5, Scale: 2}, Nullable: true},
			{Name: "list(i64)", Type: arrow.ListOf(arrow.PrimitiveTypes.Int64), Nullable: true},
			{Name: "large_list(i64)", Type: arrow.LargeListOf(arrow.PrimitiveTypes.Int64), Nullable: true},
			{Name: "fixed_size_list(i64)", Type: arrow.FixedSizeListOf(3, arrow.PrimitiveTypes.Int64), Nullable: true},
			{Name: "binary", Type: arrow.BinaryTypes.Binary, Nullable: true},
			{Name: "large_binary", Type: arrow.BinaryTypes.LargeBinary, Nullable: true},
			{Name: "fixed_size_binary", Type: &arrow.FixedSizeBinaryType{ByteWidth: 3}, Nullable: true},
