...
type ActionCreatePreparedStatementResult struct {
	...
	IsUpdate      *bool `protobuf:"varint,4,opt,name=is_update,json=isUpdate,proto3,oneof" json:"is_update,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActionCreatePreparedStatementResult) GetIsUpdate() bool {
...
type CommandStatementIngest struct {
	...
	Options       map[string]string `protobuf:"bytes,1000,rep,name=options,proto3" json:"options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_FlightSql_proto_rawDesc = "" +
	"\n" +
	"\x0fFlightSql.proto\x12\x19arrow.flight.protocol.sql\x1a google/protobuf/descriptor.proto\"'\n" +
	"\x11CommandGetSqlInfo\x12\x12\n" +
	"\x04info\x18\x01 \x03(\rR\x04info\"H\n" +
	"\x16CommandGetXdbcTypeInfo\x12 \n" +
	"\tdata_type\x18\x01 \x01(\x05H\x00R\bdataType\x88\x01\x01B\f\n" +
	"\n" +
	"_data_type\"\x14\n" +
	"\x12CommandGetCatalogs\"\x9b\x01\n" +
	...
	"\n" +
	"\b_catalogB\x1b\n" +
	"\x19_db_schema_filter_pattern\"\xbe\x02\n" +
	"\x10CommandGetTables\x12\x1d\n" +
	"\acatalog\x18\x01 \x01(\tH\x00R\acatalog\x88\x01\x01\x12<\n" +
	"\x18db_schema_filter_pattern\x18\x02 \x01(\tH\x01R\x15dbSchemaFilterPattern\x88\x01\x01\x12>\n" +
	"\x19table_name_filter_pattern\x18\x03 \x01(\tH\x02R\x16tableNameFilterPattern\x88\x01\x01\x12\x1f\n" +
	"\vtable_types\x18\x04 \x03(\tR\n" +
	"tableTypes\x12%\n" +
	"\x0einclude_schema\x18\x05 \x01(\bR\rincludeSchemaB\n" +
	"\n" +
	"\b_catalogB\x1b\n" +
	"\x19_db_schema_filter_patternB\x1c\n" +
	"\x1a_table_name_filter_pattern\"\x16\n" +
	"\x14CommandGetTableTypes\"\x88\x01\n" +
	"\x15CommandGetPrimaryKeys\x12\x1d\n" +
	"\acatalog\x18\x01 \x01(\tH\x00R\acatalog\x88\x01\x01\x12 \n" +
	"\tdb_schema\x18\x02 \x01(\tH\x01R\bdbSchema\x88\x01\x01\x12\x14\n" +
	"\x05table\x18\x03 \x01(\tR\x05tableB\n" +
	"\n" +
	"\b_catalogB\f\n" +
	"\n" +
	"_db_schema\"\x89\x01\n" +
	"\x16CommandGetExportedKeys\x12\x1d\n" +
	"\acatalog\x18\x01 \x01(\tH\x00R\acatalog\x88\x01\x01\x12 \n" +
	"\tdb_schema\x18\x02 \x01(\tH\x01R\bdbSchema\x88\x01\x01\x12\x14\n" +
	"\x05table\x18\x03 \x01(\tR\x05tableB\n" +
	"\n" +
	...
	"\n" +
	"_db_schema\"\x89\x01\n" +
	"\x16CommandGetImportedKeys\x12\x1d\n" +
	"\acatalog\x18\x01 \x01(\tH\x00R\acatalog\x88\x01\x01\x12 \n" +
	"\tdb_schema\x18\x02 \x01(\tH\x01R\bdbSchema\x88\x01\x01\x12\x14\n" +
	"\x05table\x18\x03 \x01(\tR\x05tableB\n" +
	"\n" +
	...
	"\n" +
	"pk_catalog\x18\x01 \x01(\tH\x00R\tpkCatalog\x88\x01\x01\x12%\n" +
	"\fpk_db_schema\x18\x02 \x01(\tH\x01R\n" +
	"pkDbSchema\x88\x01\x01\x12\x19\n" +
	"\bpk_table\x18\x03 \x01(\tR\apkTable\x12\"\n" +
	"\n" +
	"fk_catalog\x18\x04 \x01(\tH\x02R\tfkCatalog\x88\x01\x01\x12%\n" +
	"\ffk_db_schema\x18\x05 \x01(\tH\x03R\n" +
	"fkDbSchema\x88\x01\x01\x12\x19\n" +
	"\bfk_table\x18\x06 \x01(\tR\afkTableB\r\n" +
	"\v_pk_catalogB\x0f\n" +
	"\r_pk_db_schemaB\r\n" +
	"\v_fk_catalogB\x0f\n" +
	"\r_fk_db_schema\"{\n" +
	"$ActionCreatePreparedStatementRequest\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12*\n" +
	"\x0etransaction_id\x18\x02 \x01(\fH\x00R\rtransactionId\x88\x01\x01B\x11\n" +
	"\x0f_transaction_id\"=\n" +
	"\rSubstraitPlan\x12\x12\n" +
	"\x04plan\x18\x01 \x01(\fR\x04plan\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\"\xa7\x01\n" +
	"(ActionCreatePreparedSubstraitPlanRequest\x12<\n" +
	"\x04plan\x18\x01 \x01(\v2(.arrow.flight.protocol.sql.SubstraitPlanR\x04plan\x12*\n" +
	"\x0etransaction_id\x18\x02 \x01(\fH\x00R\rtransactionId\x88\x01\x01B\x11\n" +
	"\x0f_transaction_id\"\xe3\x01\n" +
	"#ActionCreatePreparedStatementResult\x12:\n" +
	"\x19prepared_statement_handle\x18\x01 \x01(\fR\x17preparedStatementHandle\x12%\n" +
	"\x0edataset_schema\x18\x02 \x01(\fR\rdatasetSchema\x12)\n" +
	"\x10parameter_schema\x18\x03 \x01(\fR\x0fparameterSchema\x12 \n" +
	"\tis_update\x18\x04 \x01(\bH\x00R\bisUpdate\x88\x01\x01B\f\n" +
	"\n" +
	"_is_update\"a\n" +
	"#ActionClosePreparedStatementRequest\x12:\n" +
	"\x19prepared_statement_handle\x18\x01 \x01(\fR\x17preparedStatementHandle\"\x1f\n" +
	"\x1dActionBeginTransactionRequest\"X\n" +
	"\x1bActionBeginSavepointRequest\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\fR\rtransactionId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"E\n" +
	"\x1cActionBeginTransactionResult\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\fR\rtransactionId\"?\n" +
	"\x1aActionBeginSavepointResult\x12!\n" +
	"\fsavepoint_id\x18\x01 \x01(\fR\vsavepointId\"\x90\x02\n" +
	"\x1bActionEndTransactionRequest\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\fR\rtransactionId\x12]\n" +
	"\x06action\x18\x02 \x01(\x0e2E.arrow.flight.protocol.sql.ActionEndTransactionRequest.EndTransactionR\x06action\"k\n" +
	"\x0eEndTransaction\x12\x1f\n" +
	"\x1bEND_TRANSACTION_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16END_TRANSACTION_COMMIT\x10\x01\x12\x1c\n" +
	"\x18END_TRANSACTION_ROLLBACK\x10\x02\"\xff\x01\n" +
	"\x19ActionEndSavepointRequest\x12!\n" +
	"\fsavepoint_id\x18\x01 \x01(\fR\vsavepointId\x12Y\n" +
	"\x06action\x18\x02 \x01(\x0e2A.arrow.flight.protocol.sql.ActionEndSavepointRequest.EndSavepointR\x06action\"d\n" +
	"\fEndSavepoint\x12\x1d\n" +
	"\x19END_SAVEPOINT_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15END_SAVEPOINT_RELEASE\x10\x01\x12\x1a\n" +
	"\x16END_SAVEPOINT_ROLLBACK\x10\x02\"l\n" +
	"\x15CommandStatementQuery\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12*\n" +
	"\x0etransaction_id\x18\x02 \x01(\fH\x00R\rtransactionId\x88\x01\x01B\x11\n" +
	"\x0f_transaction_id\"\x9c\x01\n" +
	"\x1dCommandStatementSubstraitPlan\x12<\n" +
	"\x04plan\x18\x01 \x01(\v2(.arrow.flight.protocol.sql.SubstraitPlanR\x04plan\x12*\n" +
	"\x0etransaction_id\x18\x02 \x01(\fH\x00R\rtransactionId\x88\x01\x01B\x11\n" +
	"\x0f_transaction_id\"A\n" +
	"\x14TicketStatementQuery\x12)\n" +
	"\x10statement_handle\x18\x01 \x01(\fR\x0fstatementHandle\"[\n" +
	"\x1dCommandPreparedStatementQuery\x12:\n" +
	"\x19prepared_statement_handle\x18\x01 \x01(\fR\x17preparedStatementHandle\"m\n" +
	"\x16CommandStatementUpdate\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12*\n" +
	"\x0etransaction_id\x18\x02 \x01(\fH\x00R\rtransactionId\x88\x01\x01B\x11\n" +
	"\x0f_transaction_id\"\\\n" +
	"\x1eCommandPreparedStatementUpdate\x12:\n" +
	"\x19prepared_statement_handle\x18\x01 \x01(\fR\x17preparedStatementHandle\"\xac\b\n" +
	"\x16CommandStatementIngest\x12\x82\x01\n" +
	"\x18table_definition_options\x18\x01 \x01(\v2H.arrow.flight.protocol.sql.CommandStatementIngest.TableDefinitionOptionsR\x16tableDefinitionOptions\x12\x14\n" +
	"\x05table\x18\x02 \x01(\tR\x05table\x12\x1b\n" +
	"\x06schema\x18\x03 \x01(\tH\x00R\x06schema\x88\x01\x01\x12\x1d\n" +
	"\acatalog\x18\x04 \x01(\tH\x01R\acatalog\x88\x01\x01\x12\x1c\n" +
	"\ttemporary\x18\x05 \x01(\bR\ttemporary\x12*\n" +
	"\x0etransaction_id\x18\x06 \x01(\fH\x02R\rtransactionId\x88\x01\x01\x12Y\n" +
	"\aoptions\x18\xe8\a \x03(\v2>.arrow.flight.protocol.sql.CommandStatementIngest.OptionsEntryR\aoptions\x1a\xaf\x04\n" +
	"\x16TableDefinitionOptions\x12~\n" +
	"\fif_not_exist\x18\x01 \x01(\x0e2\\.arrow.flight.protocol.sql.CommandStatementIngest.TableDefinitionOptions.TableNotExistOptionR\n" +
	"ifNotExist\x12w\n" +
	"\tif_exists\x18\x02 \x01(\x0e2Z.arrow.flight.protocol.sql.CommandStatementIngest.TableDefinitionOptions.TableExistsOptionR\bifExists\"\x81\x01\n" +
	...
	"\frecord_count\x18\x01 \x01(\x03R\vrecordCount\"}\n" +
	"\x1cDoPutPreparedStatementResult\x12?\n" +
	"\x19prepared_statement_handle\x18\x01 \x01(\fH\x00R\x17preparedStatementHandle\x88\x01\x01B\x1c\n" +
	"\x1a_prepared_statement_handle\"2\n" +
	"\x18ActionCancelQueryRequest\x12\x12\n" +
	"\x04info\x18\x01 \x01(\fR\x04info:\x02\x18\x01\"\x84\x02\n" +
	"\x17ActionCancelQueryResult\x12W\n" +
	"\x06result\x18\x01 \x01(\x0e2?.arrow.flight.protocol.sql.ActionCancelQueryResult.CancelResultR\x06result\"\x8b\x01\n" +
	"\fCancelResult\x12\x1d\n" +
	"\x19CANCEL_RESULT_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17CANCEL_RESULT_CANCELLED\x10\x01\x12\x1c\n" +
	"\x18CANCEL_RESULT_CANCELLING\x10\x02\x12!\n" +
	"\x1dCANCEL_RESULT_NOT_CANCELLABLE\x10\x03:\x02\x18\x01*\x92\x19\n" +
	"\aSqlInfo\x12\x1a\n" +
	"\x16FLIGHT_SQL_SERVER_NAME\x10\x00\x12\x1d\n" +
	"\x19FLIGHT_SQL_SERVER_VERSION\x10\x01\x12#\n" +
	"\x1fFLIGHT_SQL_SERVER_ARROW_VERSION\x10\x02\x12\x1f\n" +
	"\x1bFLIGHT_SQL_SERVER_READ_ONLY\x10\x03\x12\x19\n" +
	"\x15FLIGHT_SQL_SERVER_SQL\x10\x04\x12\x1f\n" +
	"\x1bFLIGHT_SQL_SERVER_SUBSTRAIT\x10\x05\x12+\n" +
	"'FLIGHT_SQL_SERVER_SUBSTRAIT_MIN_VERSION\x10\x06\x12+\n" +
	"'FLIGHT_SQL_SERVER_SUBSTRAIT_MAX_VERSION\x10\a\x12!\n" +
	"\x1dFLIGHT_SQL_SERVER_TRANSACTION\x10\b\x12\x1c\n" +
	"\x18FLIGHT_SQL_SERVER_CANCEL\x10\t\x12$\n" +
	" FLIGHT_SQL_SERVER_BULK_INGESTION\x10\n" +
	"\x123\n" +
	"/FLIGHT_SQL_SERVER_INGEST_TRANSACTIONS_SUPPORTED\x10\v\x12'\n" +
	"#FLIGHT_SQL_SERVER_STATEMENT_TIMEOUT\x10d\x12)\n" +
	"%FLIGHT_SQL_SERVER_TRANSACTION_TIMEOUT\x10e\x12\x14\n" +
	...
	"\fSQL_KEYWORDS\x10\xfc\x03\x12\x1a\n" +
	...
	"\x1aSQL_TRANSACTIONS_SUPPORTED\x10\xb3\x04\x120\n" +
	...
	";SQL_SUPPORTED_CONCURRENCIES_FOR_RESULT_SET_SCROLL_SENSITIVE\x10\xba\x04\x12B\n" +
	...
	"\x10ANSI92_ENTRY_SQL\x10\x00\x12\x1b\n" +
	"\x17ANSI92_INTERMEDIATE_SQL\x10\x01\x12\x13\n" +
	"\x0fANSI92_FULL_SQL\x10\x02*m\n" +
	...
	"\x13SQL_CONVERT_INTEGER\x10\a\x12!\n" +
	"\x1dSQL_CONVERT_INTERVAL_DAY_TIME\x10\b\x12#\n" +
	"\x1fSQL_CONVERT_INTERVAL_YEAR_MONTH\x10\t\x12\x1d\n" +
	"\x19SQL_CONVERT_LONGVARBINARY\x10\n" +
	"\x12\x1b\n" +
	"\x17SQL_CONVERT_LONGVARCHAR\x10\v\x12\x17\n" +
	"\x13SQL_CONVERT_NUMERIC\x10\f\x12\x14\n" +
	...
	"\fXdbcDataType\x12\x15\n" +
	"\x11XDBC_UNKNOWN_TYPE\x10\x00\x12\r\n" +
	"\tXDBC_CHAR\x10\x01\x12\x10\n" +
	"\fXDBC_NUMERIC\x10\x02\x12\x10\n" +
	"\fXDBC_DECIMAL\x10\x03\x12\x10\n" +
	"\fXDBC_INTEGER\x10\x04\x12\x11\n" +
	"\rXDBC_SMALLINT\x10\x05\x12\x0e\n" +
	"\n" +
	"XDBC_FLOAT\x10\x06\x12\r\n" +
	"\tXDBC_REAL\x10\a\x12\x0f\n" +
	"\vXDBC_DOUBLE\x10\b\x12\x11\n" +
	"\rXDBC_DATETIME\x10\t\x12\x11\n" +
	"\rXDBC_INTERVAL\x10\n" +
	"\x12\x10\n" +
	"\fXDBC_VARCHAR\x10\f\x12\r\n" +
	"\tXDBC_DATE\x10[\x12\r\n" +
	...
	"\vXDBC_BINARY\x10\xfe\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x1b\n" +
	...
	"\vXDBC_BIGINT\x10\xfb\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x19\n" +
	"\fXDBC_TINYINT\x10\xfa\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x15\n" +
	"\bXDBC_BIT\x10\xf9\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x17\n" +
	"\n" +
	"XDBC_WCHAR\x10\xf8\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x1a\n" +
	"\rXDBC_WVARCHAR\x10\xf7\xff\xff\xff\xff\xff\xff\xff\xff\x01*\xa3\b\n" +
	...
	"\x1aXDBC_SUBCODE_YEAR_TO_MONTH\x10\a\x12\x1c\n" +
	"\x18XDBC_SUBCODE_DAY_TO_HOUR\x10\b\x12\x1e\n" +
	"\x1aXDBC_SUBCODE_DAY_TO_MINUTE\x10\t\x12\x1e\n" +
	"\x1aXDBC_SUBCODE_DAY_TO_SECOND\x10\n" +
	"\x12\x1f\n" +
	"\x1bXDBC_SUBCODE_HOUR_TO_MINUTE\x10\v\x12\x1f\n" +
	"\x1bXDBC_SUBCODE_HOUR_TO_SECOND\x10\f\x12!\n" +
	"\x1dXDBC_SUBCODE_MINUTE_TO_SECOND\x10\r\x12\x1e\n" +
	"\x1aXDBC_SUBCODE_INTERVAL_YEAR\x10e\x12\x1f\n" +
	"\x1bXDBC_SUBCODE_INTERVAL_MONTH\x10f\x12\x1d\n" +
	...
	"\x11UpdateDeleteRules\x12\v\n" +
	"\aCASCADE\x10\x00\x12\f\n" +
	"\bRESTRICT\x10\x01\x12\f\n" +
	"\bSET_NULL\x10\x02\x12\r\n" +
	"\tNO_ACTION\x10\x03\x12\x0f\n" +
	"\vSET_DEFAULT\x10\x04:D\n" +
	"\fexperimental\x12\x1f.google.protobuf.MessageOptions\x18\xe8\a \x01(\bR\fexperimentalBV\n" +
...
var (
	...
	file_FlightSql_proto_rawDescData []byte
)

func file_FlightSql_proto_rawDescGZIP() []byte {
	file_FlightSql_proto_rawDescOnce.Do(func() {
		file_FlightSql_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_FlightSql_proto_rawDesc), len(file_FlightSql_proto_rawDesc)))
	})
...
var file_FlightSql_proto_goTypes = []any{
...
func file_FlightSql_proto_init() {
	...
	file_FlightSql_proto_msgTypes[1].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[3].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[4].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[6].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[7].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[8].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[9].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[10].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[12].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[13].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[21].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[22].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[25].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[27].OneofWrappers = []any{}
	file_FlightSql_proto_msgTypes[29].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_FlightSql_proto_rawDesc), len(file_FlightSql_proto_rawDesc)),
			NumEnums:      27,
			NumMessages:   34,
			NumExtensions: 1,
			NumServices:   0,
